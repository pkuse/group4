<div class="container">
	...
	<?php echo form_open_multipart('vote/submit_vote', array('class' => 'form-signin')) ?>
		...
		<div class="row">
			<div class="form-group col-md-6">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="vote_options_title[]" placeholder="第一个选项是什么呢" required>
				</div>
				<div class="form-group">
					<label for="description1">投票的描述</label>
					<textarea class="form-control" rows="2" id="description" name='vote_options_desc[]' placeholder="描述一下这个选项吧" ></textarea>
				</div>
				<a href="#"  class="thumbnail">
					<label for="pic1" class="sr-only">上传选项1的图片</label>
					<input type="file" id="pic1" name='vote_options_pic[]' onchange="javascript:setImagePreview(this,localImag1,preview1);" required>
			...
			<div class="form-group col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" name='vote_options_title[]' id="title" placeholder="第二个选项是什么呢" required>
				</div>
				<div class="form-group">
					<label for="description2">投票的描述</label>
					<textarea class="form-control" rows="2" name='vote_options_desc[]' id="description" placeholder="描述一下这个选项吧"></textarea>
				</div>
				<a href="#" class="thumbnail">
					<label for="pic2"class="sr-only">上传选项2的图片</label>
					<input type="file" name='vote_options_pic[]' id="pic2" onchange="javascript:setImagePreview(this,localImag2,preview2);" required>
					<p class="help-block">上传并预览图片</p>
					<div id="localImag2"  >  
